...
Run with agent on PYTHONPATH (e.g. from agent/: PYTHONPATH=. python -m echo_prism_agent.modalities.voice.livekit.main dev)
Or repo root: PYTHONPATH=agent python -m echo_prism_agent.modalities.voice.livekit.main start
...
_root = Path(__file__).resolve().parents[5]  # .../echo (repo root)
_agent_parent = Path(__file__).resolve().parents[3]  # .../echo/agent (parent of echo_prism_agent)
...
from echo_prism_agent.modalities.voice.livekit import phone_lookup
from echo_prism_agent.modalities.voice.livekit.agent import (
