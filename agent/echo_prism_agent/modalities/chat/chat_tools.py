"""
EchoPrism conversational tools and single-turn Gemini calls.

Tools (list_workflows, run_workflow, …) are shared by text chat (LangGraph-wrapped)
and voice (Gemini Live) via `modalities.voice`. Routers own WebSocket I/O and tool execution.
"""
