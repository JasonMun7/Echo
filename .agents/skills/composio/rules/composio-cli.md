...
3. **Offload analysis** — After understanding the schema, use inline bash scripts for heavy data analysis instead of manual inspection. Avoid using Composio SDK for personal use cases; only use the SDKs when building apps.
