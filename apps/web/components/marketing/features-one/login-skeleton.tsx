          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex w-full flex-col gap-3">
              <div className="flex flex-col gap-1">
                <label htmlFor="skeleton-email" className="text-[8px] font-medium text-neutral-700">
                  Email
                </label>
                <input
                  id="skeleton-email"
              ...
              <div className="flex items-center justify-between">
                <label className="flex cursor-pointer items-center gap-1">
                  ...
                  />
                  <span className="text-[7px] text-neutral-600">Remember me</span>
                </label>
                <button
                  type="button"
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[7px] text-neutral-400">or continue with</span>
                <div className="h-px flex-1 bg-neutral-200" />
              </div>
              ...
              <div className="flex gap-2">
                ...
                >
                  ...
                  <span className="text-[7px] font-medium text-neutral-700">Google</span>
                </button>
                <button
                  type="button"
                  className="flex flex-1 items-center justify-center gap-1 rounded-md bg-white py-1.5 shadow-sm ring-1 shadow-black/5 ring-black/10 transition-all hover:bg-neutral-50 active:scale-[0.98]"
                >
                  ...
                  <span className="text-[7px] font-medium text-neutral-700">GitHub</span>
                </button>
              </div>
  ...
  return (
    <div className="mt-2 w-full rounded-xl bg-white p-4 shadow-lg ring-1 ring-black/5">
      <p className="text-xs leading-relaxed text-neutral-600">
        &ldquo;Setting up auth took us 10 minutes instead of 2 weeks. The SDK just works out of the
        box with zero configuration. Our team shipped the entire login flow before lunch. Best
        developer experience we&apos;ve had.&rdquo;
      </p>
      <div className="mt-3 flex items-center gap-2">
        ...
        <div className="flex flex-col">
          <span className="text-[10px] font-medium text-neutral-800">Sarah Chen</span>
          <span className="text-[8px] text-neutral-500">CTO at TechFlow</span>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <a href="#" className="flex items-center gap-1.5">
      <div className="relative flex size-5 items-center justify-center rounded-md">
        <Image src="https://assets.aceternity.com/logo.png" height={20} width={20} alt="Logo" />
      </div>
      <span className="text-xs font-semibold text-neutral-900">Nexus</span>
    </a>
  );
}
