...
export const EdgeComputing = () => {
  ...
  return (
    <div className="relative h-40 w-full overflow-hidden">
      ...
      >
        <motion.div
          className="absolute size-8 rounded-full bg-neutral-200"
          animate={{
            scale: [1, 1.5, 1],
            opacity: [0.5, 0.2, 0.5],
          }}
        ...
        />
        <motion.div className="relative size-7 overflow-hidden rounded-full ring-2 ring-neutral-300 ring-offset-1 ring-offset-white">
          <Image
