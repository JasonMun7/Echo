    ...
    >
      ...
      <div className="flex items-center gap-0">
        ...
        <div className="relative z-10 shrink-0">
          <div className="size-7 overflow-hidden rounded-full ring-2 ring-white/50">
            <Image
              width={48}
              height={48}
        ...
        <div className="relative flex items-center">
          ...
          {/* Lock Icon Container */}
          <div className="relative z-10 shrink-0">
            <div className="flex size-10 items-center justify-center rounded-xl bg-white shadow-sm ring-1 ring-black/5">
              <IconLock className="size-4 text-neutral-600" />
            </div>
          </div>
        ...
        <div className="relative z-10 shrink-0">
          <div className="size-6 overflow-hidden rounded-full ring-2 ring-white/50">
            <Image
              width={48}
              height={48}
...
function SecurityBeam({ delay = 0 }: { delay?: number }) {
  return (
    <div className="relative h-px w-full overflow-hidden">
      ...
      <div className="absolute inset-0 border-t border-dotted border-neutral-300" />
