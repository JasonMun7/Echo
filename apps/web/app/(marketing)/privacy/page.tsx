...
export default function PrivacyPage() {
  return (
    <LegalPageTemplate title="Privacy Policy">
      ...
      <p className="mb-4">
        This Privacy Policy describes how Echo (&quot;we,&quot; &quot;us&quot;) collects, uses,
        and shares information when you use the Echo Service.
      </p>
      ...
      <p className="mb-4">
        We use information to operate and improve the Service, provide support, secure our
        systems, comply with law, and communicate with you about the Service.
      </p>
      ...
      <p className="mb-4">
        Depending on your region, you may have rights to access, correct, or delete certain
        personal information. Contact us as described below to exercise applicable rights.
      </p>
      ...
      <p className="mb-4">
        ...
        and revise the &quot;Last updated&quot; date.
      </p>
