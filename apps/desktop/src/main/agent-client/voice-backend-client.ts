/**
 * Voice backend client (desktop main process) — WebSocket to the **API** `/ws/chat?mode=voice` (same as web).
 * Not the workflow agent (`/api/agent/run`); see `remote-workflow-runner.ts` for that.
 */
